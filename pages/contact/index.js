...
const Contact = () => {
  return (
    <div className="h-full bg-gradient-to-br from-blue-50 to-green-100">
        ...
        <div className="flex flex-col w-full max-w-[700px]">
          ...
          <motion.form
            ...
            <div className="flex gap-x-6 w-full">
              <input type="text" placeholder="Nama" className="input" />
              <input type="text" placeholder="Email" className="input" />
            </div>
            <input type="text" placeholder="Judul" className="input" />
            <textarea placeholder="Kirim Pesan" className="textarea"></textarea>
